      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-3">
            Upload your company logo. It will appear throughout your dashboard.
          </p>
        ...
        <div>
          ...
          {errors.secondaryColor && (
            <p className="text-sm text-red-600 mt-2">{errors.secondaryColor}</p>
          )}
        </div>
          ...
          <div className="mt-6 p-4 rounded-lg bg-gray-50 border border-gray-200">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1">
                <div className="h-3 rounded bg-gray-200 w-32 mb-1" />
                <div className="h-2 rounded bg-gray-100 w-48" />
              </div>
            </div>
        ...
        <div className="pt-6 border-t border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() =>
                updateNestedField("theme", "darkMode", !formData.theme.darkMode)
              }
              className={`
