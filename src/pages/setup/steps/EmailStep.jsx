    ...
    <div className="container mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Set your default email sender and style. Templates adopt your logo and
          brand colors.
        </p>
      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              value={s.fromName}
              onChange={(e) =>
                updateNestedField("emailSettings", "fromName", e.target.value)
              }
              placeholder="Acme Inc"
              className={
                errors["emailSettings.fromName"] ? "border-red-500" : ""
              }
            />
          ...
          <div>
            ...
            <Input
              value={s.fromEmail}
              onChange={(e) =>
                updateNestedField("emailSettings", "fromEmail", e.target.value)
              }
              placeholder="noreply@acme.com"
              className={
                errors["emailSettings.fromEmail"] ? "border-red-500" : ""
              }
            />
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <Input
                ...
                className={
                  "flex-1 " +
                  (errors["emailSettings.headerColor"] ? "border-red-500" : "")
                }
              />
            </div>
          ...
          <div>
            ...
            <Input
              value={s.footerText}
              onChange={(e) =>
                updateNestedField("emailSettings", "footerText", e.target.value)
              }
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <button
                type="button"
                onClick={() =>
                  updateNestedField("emailSettings", "templateStyle", "modern")
                }
              ...
              <button
                type="button"
                onClick={() =>
                  updateNestedField("emailSettings", "templateStyle", "minimal")
                }
